...
interface HeaderProps {
  onAIRecommendationClick?: () => void;
}

export const Header: React.FC<HeaderProps> = ({ onAIRecommendationClick }) => {
  return (
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <button
              ...
              className="flex items-center gap-2 text-white bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 focus:ring-4 focus:ring-purple-200 font-bold rounded-lg text-sm px-4 py-2 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
