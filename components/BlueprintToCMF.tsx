...
interface BlueprintToCMFProps {
  onNavigateHome: () => void;
  onNavigateToCMFEdit?: (imageUrl: string, imageIndex: number) => void;
}

export const BlueprintToCMF: React.FC<BlueprintToCMFProps> = ({ onNavigateHome, onNavigateToCMFEdit }) => {
  // Image states
        ...
        <>
          ...
          {generatedImages.length > 0 && (
            <div className="flex justify-center gap-4">
              ...
              {onNavigateToCMFEdit && (
                <button
                  onClick={() => onNavigateToCMFEdit(generatedImages[0] ? `data:image/png;base64,${generatedImages[0]}` : '', 0)}
